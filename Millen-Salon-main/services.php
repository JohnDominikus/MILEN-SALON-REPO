...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/serves.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-pricing">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>We don't just do hair, we transform it. ‍♀️</p>
          </div>
        </div>
